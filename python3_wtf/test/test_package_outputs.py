...
class TestPackageOutputs(unittest.TestCase):
    def test_archive_outputs_creates_zip_file_and_moves_it(self):
        ...
        with tempfile.TemporaryDirectory() as temp_output_dir:
            ...
            assert os.path.isfile(zip_path), (
                "ZIP archive was not created in destination."
            )
    ...
    def test_archive_outputs_handles_missing_destination(self):
    ...
    def test_archive_outputs_creates_zip_file_with_indexed_files(self):
        # Sample input: list of (filename, [content])
        outputs = [
            ("test1", ["line 1\nline 2"]),
            ("test1", ["line 1\nline 2"]),
